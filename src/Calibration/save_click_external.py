...
for image_count in range(start_count, finish_count):
    ...
    thermal_image_path = '.results/Calibration/FOV/THERMAL/thermal_'+str(image_count) + '.jpg'
    ...
    rgb_image_path = '.results/Calibration/FOV/RGB/rgb_'+str(image_count)+'.jpg'
    ...
    save_txt =  '.results/Calibration/FOV/external/cameras_position'+str(image_count) + '.txt'
