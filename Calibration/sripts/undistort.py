...
# mtx = np.array([790.55190806, 0, 290.83581836,
#                         0, 789.02677608, 238.22512355,
#                         0 ,0 ,1]).reshape(3, 3)
# #dist = np.array(["""***************ここにあらかじめ求めておいた歪み係数を書く***************"""])
# dist = np.array([-4.84127438e-01, 6.01355976e+00, -1.00337104e-02, -1.41092178e-02, -2.37985347e+01])
mtx = np.array([770.61648493, 0, 336.94307903,
                        0, 774.81856137, 203.23000118,
                        0 ,0 ,1]).reshape(3, 3)
#dist = np.array(["""***************ここにあらかじめ求めておいた歪み係数を書く***************"""])
dist = np.array([2.64764544e-01, -4.18415905e+00, -2.55476500e-02, 1.19220012e-03, 1.52325890e+01])
